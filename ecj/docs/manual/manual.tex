...
This might be used if the Individuals being migrated are different (perhaps a different representation or fitness object) than the ones in the remote island and you need to convert them into the appropriate form.  The default form of this method just returns the Individual provided.
