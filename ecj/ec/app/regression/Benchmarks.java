 ...
 * testing data and functions for the following problems:
 ...
 <li>Twelve problems drawn from "Semantically-based Crossover in Genetic Programming: Application to Real-valued Symbolic Regression" (GPEM 2011),
    by UY Quang Uy, UY Xuan Hoai, Michael O’Neill, R.I. McKay, Edgar Galv ́an-L ́opez.  These are known as
    <b>uy-1</b> through <b>uy-12</b>
...
<p>These problems differ in a variety of ways.  Some have both training and testing data points.  Some have one variable, others up to five variables.  Some build their random points based on random samples, other based on a grid of samples distributed through the space.  Some information:

<table>
<tr><th><b>Name</b><th><b>Num Variables</b><Testing Points</b>
<tr><td>koza-1          <td>
<tr><td>koza-2
<tr><td>koza-3
<tr><td>uy-1
...
<tr><td>keijzer-14
<tr><td>keijzer-15
<tr><td>vladislavleva-1
<tr><td>vladislavleva-2
<tr><td>vladislavleva-3
<tr><td>vladislavleva-4
<tr><td>vladislavleva-5
<tr><td>vladislavleva-6
<tr><td>vladislavleva-7
<tr><td>vladislavleva-8
</table>
...
public class Benchmarks extends GPProblem implements SimpleProblemForm
	...
	// GPEM 2011
	public static final int UY1 = 3 ;
	public static final int UY2 = 4 ;  // identical to standard Koza
	public static final int UY3 = 5 ;
	public static final int UY4 = 6 ;
	public static final int UY5 = 7 ;
	public static final int UY6 = 8 ;
	public static final int UY7 = 9 ;
	public static final int UY8 = 10 ;
	public static final int UY9 = 11 ;
	public static final int UY10 = 12 ;
	public static final int UY11 = 13 ;
	public static final int UY12 = 14 ;
    ...
    public static final int PAGIE1 = 15;
	
	// From Accuracy in Symbolic Regression -- GPTP 2011
	public static final int KORNS1 = 16 ;
	public static final int KORNS2 = 17 ;
	public static final int KORNS3 = 18 ;
	public static final int KORNS4 = 19 ;
	public static final int KORNS5 = 20 ;
	public static final int KORNS6 = 21 ;
	public static final int KORNS7 = 22 ;
	public static final int KORNS8 = 23 ;
	public static final int KORNS9 = 24 ;
	public static final int KORNS10 = 25 ;
	public static final int KORNS11 = 26 ;
	public static final int KORNS12 = 27 ;
	public static final int KORNS13 = 28 ;
	public static final int KORNS14 = 29 ;
	public static final int KORNS15 = 30 ;
	
	// From Improving Symbolic Regression with Interval Arithmetic and Linear Scaling
	// Maarten Keijzer -- EuroGP 2003
	public static final int KEIJZER1 = 31 ;
	public static final int KEIJZER2 = 32 ;
	public static final int KEIJZER3 = 33 ;
	public static final int KEIJZER4 = 34 ;
	public static final int KEIJZER5 = 35 ;
	public static final int KEIJZER6 = 36 ;
	public static final int KEIJZER7 = 37 ;				
	public static final int KEIJZER8 = 38 ;
	public static final int KEIJZER9 = 39 ;
	public static final int KEIJZER10 = 40 ;
	public static final int KEIJZER11 = 41 ;
	public static final int KEIJZER12 = 42 ;
	public static final int KEIJZER13 = 43 ;
	public static final int KEIJZER14 = 44 ;
	public static final int KEIJZER15 = 45 ;
	...
	public static final int VLADISLAVLEVA1 = 46 ;
	public static final int VLADISLAVLEVA2 = 47 ;
	public static final int VLADISLAVLEVA3 = 48 ;
	public static final int VLADISLAVLEVA4 = 49 ;
	public static final int VLADISLAVLEVA5 = 50 ;
	public static final int VLADISLAVLEVA6 = 51 ;				
	public static final int VLADISLAVLEVA7 = 52 ;
	public static final int VLADISLAVLEVA8 = 53 ;
	...
	public static final String names[] = 
		...
		"uy-1", "uy-2", "uy-3", "uy-4", "uy-5", "uy-6", "uy-7", "uy-8", "uy-9", "uy-10", "uy-11", "uy-12",
        "pagie-1",
	...
	public double[][] trainPoints(EvolutionState state, int benchmark, int threadnum)
		...
		switch(benchmark)
            ...
            case PAGIE1:
                return generateIntervalSpacedSamples(state, -5, 5, 0.4, threadnum);
	...
	public double func(EvolutionState state, double[] xs, int benchmark) throws IllegalArgumentException
		...
		switch(benchmark)
			...
			case UY8:				// Note this presumes you don't have sqrt(x) in your function set!
				return Math.sqrt(x);
			case UY9:
			...
			case KEIJZER7:				// Note this presumes you don't have log(x) in your function set!
				return Math.log(x);
			case KEIJZER8:				// same as UY8
				return Math.sqrt(x);
			case KEIJZER9:
				return asinh(x);   // Not a function in Math
			case KEIJZER10:
				return Math.pow(x, y);	// same as UY11
			case KEIJZER11:
...
///// Setup
    ...
    public void setup(EvolutionState state, Parameter base)
        ...
        data = (RegressionData) state.parameters.getInstanceForParameterEq(
