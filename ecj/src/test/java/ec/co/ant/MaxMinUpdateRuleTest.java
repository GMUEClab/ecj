...
import ec.co.ant.MaxMinUpdateRule.BestStrategy;
 ...
 * @author Eric O. Scott
 */
public class MaxMinUpdateRuleTest {
    ...
    public void setUp()
    {
        ...
        params.set(PHEROMONES_BASE.push(SimplePheromoneTable.P_INITIAL_CONCENTRATION), "100.0");
        params.set(BASE.push(MaxMinUpdateRule.P_BEST_STRATEGY), BestStrategy.GLOBAL_BEST.toString());
        params.set(BASE.push(MaxMinUpdateRule.P_RHO), "0.3");
        params.set(BASE.push(MaxMinUpdateRule.P_MAX),"100");

        params.set(BASE.push(MaxMinUpdateRule.P_DECAY_RATE), "0.5");
    ...
    public void testSetup1() {
        MaxMinUpdateRule instance = new MaxMinUpdateRule();
    ...
    public void testSetup2() {
        params.set(BASE.push(MaxMinUpdateRule.P_BEST_STRATEGY), BestStrategy.ITERATION_BEST.toString());
        MaxMinUpdateRule instance = new MaxMinUpdateRule();
        instance.setup(state, BASE);
    ...
    /**
     * Test of updatePheromones method, of class MaxMinUpdateRule.
     */
    @Test
    public void testUpdatePheromones() {
        ...
        assertEquals(50.0, pheromones.get(state, pComponents.get(0), 0), 0.00000001);
        assertEquals(335.0, pheromones.get(state, pComponents.get(1), 0), 0.00000001);
        assertEquals(335.0, pheromones.get(state, pComponents.get(2), 0), 0.00000001);
        assertEquals(335.0, pheromones.get(state, pComponents.get(3), 0), 0.00000001);
        assertEquals(335.0, pheromones.get(state, pComponents.get(4), 0), 0.00000001);
        assertEquals(50.0, pheromones.get(state, pComponents.get(5), 0), 0.00000001);
        assertEquals(50.0, pheromones.get(state, pComponents.get(6), 0), 0.00000001);
        assertEquals(50.0, pheromones.get(state, pComponents.get(7), 0), 0.00000001);
        assertEquals(50.0, pheromones.get(state, pComponents.get(8), 0), 0.00000001);
        assertEquals(50.0, pheromones.get(state, pComponents.get(9), 0), 0.00000001);
    }
