...
public class AdvancedIntegerVectorSpecies extends IntegerVectorSpecies {
	...
	public static final String P_UNIFORM_CROSSOVER_PROB = "uniform-crossover-prob";
	...
	public float uniformCrossoverProbability;
	...
	public void setup(EvolutionState state, Parameter base) {
		...
		uniformCrossoverProbability  = state.parameters.getFloatWithDefault(base.push(P_UNIFORM_CROSSOVER_PROB), def
				.push(P_UNIFORM_CROSSOVER_PROB), 0.5f);
