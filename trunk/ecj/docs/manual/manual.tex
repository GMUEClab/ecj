...
There exist some rare problems where you don't need to transfer {\it any} data between nodes: essentially they all take and return ``void'', as it were.  In this case, there's no need to make your own empty GPData subclass: just use GPData directly.
