...
public class GEPIndividual extends Individual
{
     ...
     * 
     * @param valueIndex an index that speifies which value to use in each terminal in the expression.
     * @return the value of the expression for the indiviual.
     */
     ...
     *  the expression tree from this root node down (all it subnodes/parameters).
     *  The indices of the array returned are relative
     *  to the beginning of the first integer id assigned for the terminals. That
     *  is to say, index 0 in the array refers to the count of the 1st variable in the list of
     *  terminals.
     *  
